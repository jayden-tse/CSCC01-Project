...
class DatabaseCreate {
    ...
    async createUser(user, questionnaire) {
        ...
        let userProfile = new Profile(new ObjectId(), 'https://storage.googleapis.com/sample-bucket-sc/image1.jpg', '', '', questionnaire, [], [], 200, { facebook: '', instagram: '', twitter: '' }, debate, FANALYST, 0);
