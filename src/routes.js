...
router.put('profile/update/links', profileController.profile_update_links_facebook_put);

// Update profile link for twitter
router.put('profile/update/links', profileController.profile_update_links_twitter_put);

// Update profile link for instagram
router.put('profile/update/links', profileController.profile_update_links_instagram_put);
